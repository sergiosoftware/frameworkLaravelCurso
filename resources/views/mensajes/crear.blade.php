            ...
            @section('contenido')
                ...
                <form method="POST" action={{ route('guardar-mensaje') }}>
                    ...
                    <div class="form-group">                        
                        ...
                        <input class="form-control" type="email" name="correo" placeholder="Correo..." value="{{ old('correo') }}"><br>
                        ...
                        <textarea class="form-control" name="contenido" placeholder="Mensaje..." value="{{ old('contenido') }}"></textarea><br>
